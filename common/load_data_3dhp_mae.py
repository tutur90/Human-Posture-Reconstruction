...
class Fusion(data.Dataset):
    def __init__(self, opt, root_path, train=True, MAE=False):
        ...
        if self.train:
            ...
            #                                                                        subset=self.subset)
            self.generator = ChunkedGenerator(opt.batch_size // opt.stride, None, self.poses_train,
            ...
            #                                                                     subset=self.subset)
            self.generator = ChunkedGenerator(opt.batch_size // opt.stride, None, self.poses_test,
