...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('--dataset', type=str, default='data_train_3dhp')
        ...
        self.parser.add_argument('--root_path', type=str, default='/media/arthur/Data/Human-Posture-Reconstruction/data/')
        ...
        self.parser.add_argument('--train', action='store_true', default=True)
        ...
        self.parser.add_argument('--refine', action='store_true', default=False)
        self.parser.add_argument('--reload', action='store_true', default=False)
        self.parser.add_argument('--refine_reload', action='store_true', default=False)
