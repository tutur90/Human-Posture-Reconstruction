...
data_path=r'/data/shuoyang67/MPI-INF-3DHP/mpi_inf_3dhp_train_set'
cam_set = [0, 1, 2, 4, 5, 6, 7, 8]
# joint_set = [8, 6, 15, 16, 17, 10, 11, 12, 24, 25, 26, 19, 20, 21, 5, 4, 7]
joint_set = [7, 5, 14, 15, 16, 9, 10, 11, 23, 24, 25, 18, 19, 20, 4, 3]
    ...
    for file in files:
        if file.endswith("mat"):
            ...
            for cam_idx in range(len(data_2d)):
                ...
                data_2d_select = np.float32(data_2d_cam[:frames, joint_set])
                data_3d_select = np.float32(data_3d_cam[:frames, joint_set])
